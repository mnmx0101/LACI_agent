...
- [ ] **Performance implication stated:** Relevant performance value and metric implication are stated for this use case.
- [ ] **Spatial/temporal fit checked:** Model output unit aligns with or is constrained for the IPC analysis unit/time window.
- [ ] **Final verdict simplified:** Verdict is clear, with bullet-point reasoning.
