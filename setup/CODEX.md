...
- `workflows/02_Model_Paper_To_Learn_Card.md`
- `workflows/03_Model_Paper_To_Assess_Card.md`
- `workflows/04_Operational_Note_To_Use_Checklist.md`
- `workflows/05_Context_Specific_Limitation_Match.md`
- `workflows/06_Final_Decision_Guide.md`
...
```text
Use LACI_agent to draft a Learn Card from the model paper I provide.
...
```text
Use LACI_agent to draft or revise an Assess Card.
...
```text
Use LACI_agent to draft an IPC Analysis Use Checklist.
