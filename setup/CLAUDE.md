...
- **I have a model paper:** ask Claude to use `workflows/02_Model_Paper_To_Learn_Card.md`.
- **I have a Learn Card:** ask Claude to use `workflows/03_Model_Paper_To_Assess_Card.md`.
- **I have a specific IPC use case and operational note:** ask Claude to use `workflows/04_Operational_Note_To_Use_Checklist.md`.
- **I need a skeptical review:** ask Claude to use `skills/LACI_Red_Team_Reviewer.md`.
...
```text
Use the LACI_agent workflow to draft a Learn Card from this model paper.
Follow templates/LACI_Learn_Card_Template.md.
...
```text
Use the LACI_agent workflow to draft an Assess Card from the existing Learn Card and source evidence.
Follow templates/LACI_Assess_Card_Template.md.
...
```text
Use the LACI_agent workflow to draft an IPC Analysis Use Checklist.
...
Use templates/LACI_IPC_Analysis_Use_Checklist_Template.md.
```
