...
- **Drafting:** LACI_assistant and the IPC-LACI Team may draft Learn and Assess Cards from public papers, public documentation, operational notes, and available metadata.
